  ...
  return (
    <div className="flex h-screen overflow-hidden bg-muted/30">
      <a
        ...
        className="sr-only focus:not-sr-only focus:fixed focus:top-2 focus:left-2 focus:z-[100] focus:px-4 focus:py-2 focus:bg-background focus:text-foreground focus:rounded-md focus:shadow-lg focus:outline-none"
      >
      ...
      <div className="flex flex-col flex-1 min-w-0">
        <MobileAdminHeader />
        <main id="admin-main-content" className="flex-1 overflow-y-auto p-4 md:p-6 lg:p-8">
          <Outlet />
        </main>
      </div>
    </div>
