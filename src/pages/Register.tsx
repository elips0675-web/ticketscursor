...
export default function Register() {
  ...
  const {
    ...
    defaultValues: { department: '', title: '' },
  })
      ...
      <Card className="w-full max-w-md">
        ...
        <CardContent>
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            {errors.root && (
              <div role="alert" className="p-3 rounded-lg bg-destructive/10 text-destructive text-sm font-medium">
                {errors.root.message}
              </div>
            )}
            <div className="space-y-1.5">
              ...
              <Input id="reg-name" {...register('name')} placeholder={t('auth.namePlaceholder')} />
            ...
            <div className="space-y-1.5">
              ...
              <Input id="reg-email" type="email" {...register('email')} placeholder="ivan@company.ru" />
            ...
            <div className="space-y-1.5">
              ...
              <Input id="reg-password" type="password" {...register('password')} placeholder={t('auth.passwordMin')} />
            ...
            <div className="space-y-1.5">
              <label htmlFor="reg-title" className="text-sm font-bold">
                {t('auth.titlePosition')}
              </label>
              <Input id="reg-title" {...register('title')} placeholder={t('auth.titlePlaceholder')} />
            </div>
